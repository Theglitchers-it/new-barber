      ...
      <CardContent className="p-6 sm:p-8">
        ...
        {process.env.NODE_ENV === "development" && (
          <div className="mt-5 border-t border-border/30 pt-4">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground mb-2.5 text-center">Demo</p>
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => fillDemo("admin@salonpro.it", "admin123")}
                className="p-2.5 rounded-xl border border-border hover:border-primary/30 hover:bg-primary/5 transition-all text-left"
              >
                <p className="text-xs font-bold">Admin</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">admin@salonpro.it</p>
              </button>
              <button
                type="button"
                onClick={() => fillDemo("maria.rossi@email.it", "cliente123")}
                className="p-2.5 rounded-xl border border-border hover:border-primary/30 hover:bg-primary/5 transition-all text-left"
              >
                <p className="text-xs font-bold">Cliente</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">maria.rossi@email.it</p>
              </button>
            </div>
          </div>
        )}
